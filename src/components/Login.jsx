  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, fontWeight: 600, letterSpacing: '.08em', textTransform: 'uppercase', color: '#888780', marginBottom: 8 }}>
          Fábrica de Ideias
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 600, color: '#2C2C2A', marginBottom: 8 }}>
          Agenda de Produção
        </h1>
        <p style={{ fontSize: 13, color: '#5F5E5A', marginBottom: 32, lineHeight: 1.6 }}>
          Acesse com sua conta Google para visualizar a agenda da equipe.
        </p>
